<?php
    ...
    if (isset($_SESSION["admin"]) || isset($_SESSION["login"])){
        ...
        if (isset($_SESSION["email"])){
            ...
            $nama_pembeli = $account["nama_depan"] . " " . $account["nama_belakang"];
        }
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql_insert = "INSERT INTO pembelian VALUES (0, 'Mobile Legends: Bang Bang', '$nama_pembeli', '$userid ($server)', '$kategori', '$jumlah', '$metode', '$norek_telepon', '$waktu', '$email')";
