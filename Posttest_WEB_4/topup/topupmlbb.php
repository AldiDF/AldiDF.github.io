...
<body>
    ...
    <main class="container">
        <form action="../receipt/receipt_mlbb.php" class="top-up-container" method="POST">
            ...
            <div class="right-content">
                <div class="input-content">
                    <h2>Masukkan:</h2>
                    <div class="input-box">
                        <input type="text" placeholder="Id Pengguna" class="input-form" id="id" name="ID" required>
                        <input type="text" placeholder="(     Server    )" class="input-form" id="server" name="serv" required>
                        </div>
                </div>
                ...
                <div class="top-up-content">
                    <div id="menu2" class="menu-diamond-mlbb">
                        <div class="radio-wdp">
                            <input type="radio" id="radio2.1" name="top-up-wdp" onclick="methodt(1)">
                            <label for="radio2.1">
                ...
                <div class="top-up-content">
                    <div id="menu3" class="menu-diamond-mlbb">
                        <div class="radio-twilight">
                            <input type="radio" id="radio3.1" name="top-up-twilight" onclick="methodt(1)">
                            <label for="radio3.1">
                    ...
                    <div class="checkout-content" id="other">
                        ...
                        <div class="input-box-payment">
                            ...
                            <input type="number" min="0" placeholder="Nomor Rekening/Telepon" class="payment-form" name="number"required><br>
                            <input type="submit" value="Beli Sekarang" class="checkout-button">
                        </div>
                    </div>
                </div>
            </div>
