...
<body>
    ...
    <main>
        <form action="../receipt/receipt_mla.php" class="top-up-container" method="POST">
            ...
            <div class="right-content">
                <div class="input-content">
                        <h2>Masukkan:</h2>
                        <div class="input-box">
                            <input type="text" placeholder="Id Pengguna" class="input-form-mla" id="id" name="ID" required>
                            <input type="text" placeholder="(     Server    )" class="input-form-mla" id="server" name="serv" required>
                        </div>
                </div>
