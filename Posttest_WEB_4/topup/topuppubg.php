...
<body>
    ...
    <main>
        <form action="../receipt/receipt_pubg.php" class="top-up-container" method="POST">
        ...
        <div class="right-content">
            <div class="input-content">
                ...
                <div class="input-box-ff">
                    <input type="text" placeholder="Id Pengguna" class="input-form-pubg" name="ID" required>
                </div>
            </div>
            <div class="category-content">
                <h2>Pilih Kategori</h2>
                <div class="radio-category-ff">
                    <input type="radio" id="radio1" name="kategori" onclick="category(1)">
                    <label for="radio1">
