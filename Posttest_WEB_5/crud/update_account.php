<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $direktori = "saves/" . $foto;
        $typefile = pathinfo($foto,PATHINFO_EXTENSION);
        $tipe = array("jpg", "jpeg", "png", "gif");
        $temp = $_FILES["image"]["tmp_name"];
        
        if (in_array($typefile, $tipe)){
...
<body>
    ...
    <main class="login-container">
        <div class="box-login">
            ...
            <div class="box-form">
                <div class="box-mail">
                    <form action="" method="post" id="registerForm" onsubmit="return limit_number_forRegister()"enctype="multipart/form-data">
                        <div class="upload-picture">
                            <b>Foto  Frofil</b><br>
                            <label for="photo" class="input-picture"><p class="title-up" id="title">Upload</p></label>
                            <input type="file" name="image" id="photo" onchange="upload()">
                        </div><br><br>
